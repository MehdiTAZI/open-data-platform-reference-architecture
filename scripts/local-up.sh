...
kubectl -n odp-system delete job polaris-bootstrap lakehouse-bootstrap --ignore-not-found >/dev/null 2>&1 || true
...
kubectl -n odp-system wait --for=condition=complete job/lakehouse-bootstrap --timeout=300s
